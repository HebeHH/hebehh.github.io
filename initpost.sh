...
#
# Program: initpost.sh
# Author:  Vitor Britto & Hrishi Olickel
...
# Set your blog URL
BLOG_URL="http://hebehh.github.io"
...
initpost_file() {
    if [ ! -f "$FILE_NAME" ]; then
        ...
        e_success "You may need to backdate the post if you want it to show up now. Sorry about that..."
    else
